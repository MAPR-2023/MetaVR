...
public class Alignment : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool AButtonDown = OVRInput.GetDown(OVRInput.Button.One) || Input.GetKeyDown(KeyCode.A);
        bool BButtonDown = OVRInput.GetDown(OVRInput.Button.Two) || Input.GetKeyDown(KeyCode.B);
